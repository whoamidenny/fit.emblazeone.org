...
use backend\modules\products\models\ProductsIngredients;
use backend\modules\products\models\SearchModel;
use backend\modules\products\models\ProductsCategories;
use yii;

class IngredientsController extends OneModelBaseController
{

    public function init()
    {
        $this->ModelName = ProductsIngredients::className();
        return parent::init();
    }

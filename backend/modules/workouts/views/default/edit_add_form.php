...
<div class="card">
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-6">
                <?=$form->field($model,'category_id')->dropDownList(\backend\modules\workoutsCategories\models\WorkoutsCategories::getList())?>
            </div>
            <div class="col-md-6">
                <?=$form->field($model,'exercises_ids')->dropDownList(\backend\modules\exercises\models\Exercises::getList(),['multiple'=>'multiple','class'=>'select2', 'style'=>'width:100%;'])?>
                <?
            ...
            <div class="card-body">
                <?php
                    echo \wbp\imageUploader\ImageUploader::widget([
                        ...
                        'data' => ['size' => '123x123'],
                        'type' => \backend\modules\workouts\models\Workouts::$imageTypes[0],
                        'item_id' => $model->id,
                        'limit' => 1
                    ]);
                ?>

                ...
                <?
                    ...
                    $colums=[
                        ...
                        [
                            'format'=>'raw',
                            'value' => function ($data) {
                                if($data->image) return Html::img($data->image->getUrl('100'));
                                else return '';
                            }
                        ],
                        'title',
                                ...
                                return "
                                    <div class=\"btn-group dropdown\">
                                        ...
                                        <div class=\"dropdown-menu\" x-placement=\"top-start\">
                                            ...
                                            " . (!Yii::$app->controller->module->actions['enable_delete']?'':\yii\helpers\Html::a('Remove', ['delete', 'id' => $data->id], ['data' => ["pjax" => 0], "class" => "dropdown-item removeItem"]) ). "
                                        </div>
                                    </div>
                                ";
                            }
